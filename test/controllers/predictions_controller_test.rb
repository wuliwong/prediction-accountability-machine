...
class PredictionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prediction" do
    assert_difference("Prediction.count") do
      post predictions_url, params: { prediction: { link: @prediction.link, target_date: @prediction.target_date, user_id: @prediction.user_id } }
    end
  ...
  test "should update prediction" do
    patch prediction_url(@prediction), params: { prediction: { link: @prediction.link, target_date: @prediction.target_date, user_id: @prediction.user_id } }
